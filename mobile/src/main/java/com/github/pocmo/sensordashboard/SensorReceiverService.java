...
public class SensorReceiverService extends WearableListenerService {
    ...
    private void unpackSensorData(int sensorType, DataMap dataMap) {
        String devicename = dataMap.getString(DataMapKeys.DEVICENAME);
        ...
        Log.d(TAG, "Received sensor data from " + devicename +" sensor " + sensorType + " = " + Arrays.toString(values));

        sensorManager.addSensorData(devicename,sensorType, accuracy, timestamp, values);
    }
}
